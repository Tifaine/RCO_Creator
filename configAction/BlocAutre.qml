...
Item {
    ...
    signal autreTailleChange(int taille)
    Component.onCompleted:
    {
        root.state = "ferme"
        autreTailleChange(70)
    }
        ...
        onCustomCurrentIndexChanged:
        {
            if(indice === 2)
            {
                ...
                if(tfId.visible===false)
                {
                    ...
                    autreTailleChange(root.height+tfId.height+5)
                }
            }else
            {
        ...
        onCustomCurrentIndexChanged:
        {
            if(indice === 2)
            {
                ...
                if(tfValue.visible===false)
                {
                    ...
                    autreTailleChange(root.height+tfValue.height+5)
                }
            }else
            {
    ...
    Button {
        ...
        onClicked:
        {
            if(nbClic ===0)
            {
                ...
                if(tfId.visible === true)
                {
                    autreTailleChange(tailleToSend+tfId.height+5)
                }else
                {
                    autreTailleChange(tailleToSend)
                }
            }else
            {
