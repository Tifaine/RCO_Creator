...
Item {
    ...
    signal moteurTailleChange(int taille)
    Component.onCompleted:
    {
        root.state = "ferme"
        moteurTailleChange(70)
    }
        ...
        onCustomCurrentIndexChanged:
        {
            if(indice === 2)
            {
                ...
                if(tfId.visible===false)
                {
                    ...
                    moteurTailleChange(root.height+tfId.height+5)
                }
            }else
            {
        ...
        onCustomCurrentIndexChanged:
        {
            if(indice === 2)
            {
                ...
                if(tfValue.visible===false)
                {
                    ...
                    moteurTailleChange(root.height+tfValue.height+5)
                }
            }else
            {
    ...
    Button {
        ...
        onClicked:
        {
            if(nbClic ===0)
            {
                ...
                if(tfId.visible === true)
                {
                    moteurTailleChange(tailleToSend+tfId.height+5)
                }else
                {
                    moteurTailleChange(tailleToSend)
                }
            }else
            {
                root.state = "ouvert"
